...
<html lang="en">
<head>
	<title><strong>Doctor | Add Patient</strong></title>
    ...
    body {
        ...
        background-image: url('https://elixiraid.com/wp-content/uploads/2016/09/Hospital-Management-System-1-1024x328.png');
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle"><strong>Patient | Add Patient</strong></h1>
							</div>
							<ol class="breadcrumb">
